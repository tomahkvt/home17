...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("**/device**").access("hasRole('ROLE_ADMIN')").antMatchers("/uploadpage**")
				...
				.antMatchers("/**").authenticated().and().formLogin().and().httpBasic().and().logout()
